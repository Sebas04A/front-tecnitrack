import {
    ContactoDirectoRequest,
    ContactoDirectoResponse,
    ContactoDirectoResponseListApiResponse,
    ContactosEmpresaRequest,
    ContactosEmpresaResponse,
} from '../api'
...
export const parseAdapterContactoEmpresa = (
    data: ContactosEmpresaResponse
): ContactoEmpresaData => {
    return {
        id: data.id ?? 0,
        nombre: data.nombre ?? '',
...
export const parseAdapterContactosEmpresa = (
